    ...
    <main class="flex-grow">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center gap-12">
                    <div class="flex-1">
                        ...
                        @guest
                            <a href="{{ route('login') }}" class="inline-block px-6 py-3 bg-white text-blue-600 font-bold rounded-lg hover:bg-gray-100">Masuk Sekarang</a>
                        @endguest
                    </div>
                    <div class="flex-1">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    <div class="text-4xl font-bold text-blue-600">57</div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div>
                    <h4 class="text-xl font-bold text-blue-600 mb-4">Visi</h4>
                ...
                <div>
                    <h4 class="text-xl font-bold text-blue-600 mb-4">Misi</h4>
