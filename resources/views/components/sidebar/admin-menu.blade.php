...
<nav class="p-3 sm:p-4 space-y-1 sm:space-y-2 flex-1">
    ...
    <a href="{{ route('pelatih.index') }}" class="block px-3 sm:px-4 py-2 rounded-lg transition text-sm sm:text-base {{ request()->routeIs('pelatih.index') ? 'bg-green-600 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
        <svg class="w-4 h-4 sm:w-5 sm:h-5 inline mr-2" fill="currentColor" viewBox="0 0 20 20">
