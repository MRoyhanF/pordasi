    ...
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
        ...
        <form id="editForm" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="editName" name="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Contoh: Jambi" required>
