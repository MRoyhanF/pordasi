...
<!-- Modals -->
@include('kabupaten.partials.modal-create-kabupaten')
@include('kabupaten.partials.modal-edit-kabupaten')
@include('kabupaten.partials.modal-delete-kabupaten')

<!-- Scripts -->
@vite('resources/js/kabupaten/init.js')
