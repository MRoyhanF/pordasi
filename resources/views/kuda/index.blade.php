...
<div class="bg-gradient-to-r from-green-600 to-green-800 text-white p-4 sm:p-6 lg:p-8">
    <div class="flex items-center justify-between mb-2">
        <h2 class="text-xl sm:text-2xl lg:text-3xl font-bold">Data Kuda</h2>
        <button class="create-btn px-4 py-2 bg-white text-green-600 rounded-lg hover:bg-gray-100 transition text-sm font-medium">
            + Tambah Kuda
        </button>
    </div>
    <p class="text-green-100 text-sm sm:text-base">Kelola dan lihat data kuda</p>
</div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden flex flex-col">
        ...
        <table id="kudaTable" class="w-full">
            <thead>
                <tr>
                    ...
                    <th class="text-left px-4 py-3 text-sm font-semibold text-gray-700 bg-gray-50 border-b">Nama Kuda</th>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between px-4 py-4 bg-gray-50 border-t border-gray-100 gap-4">
            <div class="text-sm text-gray-600">
                Menampilkan <span id="startItem" class="font-semibold">1</span> hingga <span id="endItem" class="font-semibold">10</span> dari <span id="totalItems" class="font-semibold">{{ count($kuda) }}</span> data
            </div>
...
<!-- Modals -->
@include('kuda.partials.modal-create-kuda')
@include('kuda.partials.modal-edit-kuda')
@include('kuda.partials.modal-delete-kuda')

<!-- Scripts -->
@vite('resources/js/kuda/init.js')
