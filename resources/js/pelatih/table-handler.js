export class TableHandler {
    ...
    attachEventListeners() {
        ...
        if (this.levelFilter) this.levelFilter.addEventListener('change', () => this.applyFilters());
    ...
    applyFilters() {
        ...
        const level = this.levelFilter ? this.levelFilter.value : '';
        ...
        this.filteredRows = this.allRows.filter(row => {
            ...
            return stableMatch && levelMatch && searchMatch;
        });
    ...
    renderTableBody() {
        ...
        if (paginated.length === 0) {
            ...
            row.innerHTML = `<td colspan="8" class="text-center text-gray-500 py-8 text-sm">Tidak ada data pelatih</td>`;
